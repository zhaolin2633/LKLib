package cn.app.library.dialog.picker.imageview;
...
import cn.app.library.dialog.picker.imageview.file.AttachmentStore;
import cn.app.library.dialog.picker.imageview.file.FileUtil;
...
public class ImageUtil {
    ...
    public static Bitmap getDefaultBitmapWhenGetFail() {
        try {
            return getBitmapImmutableCopy(AppLibInitTools.appContext.getResources(), R.drawable.nim_image_default);
        } catch (Exception e) {
            e.printStackTrace();
            return null;
        }
