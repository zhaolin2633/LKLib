package cn.app.library.widget.circularProgressButton;
...
/**
 * 来源https://github.com/dmytrodanylyk/circular-progress-button
 * 可以显示进度的按钮，适用于点击按钮后执行一个长时间操作，此时可直接在按钮上显示进度。
 * <cn.app.library.widget.CircularProgressButton
