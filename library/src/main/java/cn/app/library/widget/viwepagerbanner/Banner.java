...
import cn.app.library.widget.viwepagerbanner.listener.OnBannerClickListener;
import cn.app.library.widget.viwepagerbanner.listener.OnBannerListener;
import cn.app.library.widget.viwepagerbanner.loader.ImageLoaderInterface;
import cn.app.library.widget.viwepagerbanner.view.BannerViewPager;
...
public class Banner extends FrameLayout implements OnPageChangeListener {
    ...
    private void handleTypedArray(Context context, AttributeSet attrs) {
        ...
        titleBackground = typedArray.getColor(R.styleable.Banner_title_background_, BannerConfig.TITLE_BACKGROUND);
