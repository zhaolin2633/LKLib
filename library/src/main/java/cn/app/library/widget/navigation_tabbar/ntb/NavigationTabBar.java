...
package cn.app.library.widget.navigation_tabbar.ntb;
...
import cn.app.library.widget.navigation_tabbar.behavior.NavigationTabBarBehavior;


/**
 * 来源https://github.com/Devlight/NavigationTabBar
 * Check out in code init:
 * <p>
 * final NavigationTabBar navigationTabBar = (NavigationTabBar) findViewById(R.id.ntb);
 * final ArrayList<NavigationTabBar.Model> models = new ArrayList<>();
 * models.add(new NavigationTabBar.Model.Builder(getResources().getDrawable(R.drawable.ic_first),
 * Color.parseColor(colors[0])).title("Heart")
 * .badgeTitle("NTB")
 * .build());
 * models.add(new NavigationTabBar.Model.Builder(getResources().getDrawable(R.drawable.ic_second),
 * Color.parseColor(colors[1])).title("Cup")
 * .badgeTitle("with")
 * .build());
 * models.add(new NavigationTabBar.Model.Builder(getResources().getDrawable(R.drawable.ic_third),
 * Color.parseColor(colors[2])).title("Diploma")
 * .badgeTitle("state")
 * .build());
 * models.add(new NavigationTabBar.Model.Builder(getResources().getDrawable(R.drawable.ic_fourth),
 * Color.parseColor(colors[3])).title("Flag")
 * .badgeTitle("icon")
 * .build());
 * models.add(new NavigationTabBar.Model.Builder(getResources().getDrawable(R.drawable.ic_fifth),
 * Color.parseColor(colors[4])).title("Medal")
 * .badgeTitle("777")
 * .build());
