...
public final class GlideRequests extends RequestManager {
  ...
  protected void setRequestOptions(@NonNull RequestOptions toSet) {
    if (toSet instanceof cn.app.library.widget.glideimageview.progress.GlideOptions) {
      super.setRequestOptions(toSet);
    } else {
      super.setRequestOptions(new cn.app.library.widget.glideimageview.progress.GlideOptions().apply(toSet));
    }
  }
}
